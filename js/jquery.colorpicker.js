        ...
        function initColor(){
            ...
            for(i=0;i<2;i++){
                for(j=0;j<6;j++){
                    ...
                    colorTable=colorTable+'<td width=11 rel="#000000" style="background-color:#eee">'
            ...
            colorTable='<table width=253 border="0" cellspacing="0" cellpadding="0" style="border:1px solid #444;">'
